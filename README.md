# Active-Directory Set-Up Documentation
...
Here is a list of the technical skills utilized for your project:
...
- **User Management**: Creating and managing user accounts and organizational units.
